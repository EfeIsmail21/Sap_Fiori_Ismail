		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#beapeduzsd049peoplelist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beapeduzsd049peoplelist-display": {
								"semanticObject": "beapeduzsd049peoplelist",
								"action": "display",
								"description": "Gives a list of people",
								"title": "List Of People",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.ap.edu.zsd049peoplelist",
									"url": sap.ui.require.toUrl("be/ap/edu/zsd049peoplelist")
								}
							}
						}
					}
